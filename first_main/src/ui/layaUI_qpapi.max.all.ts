...
module ui.qpapi.dating {
    export class Loading_SPUI extends View {
        ...
        public static  uiView:any ={"type":"View","props":{"width":720,"height":1280},"child":[{"type":"Box","props":{"top":-1,"right":-1,"left":-1,"bottom":-1},"child":[{"type":"Image","props":{"top":0,"skin":"ui/loading/tu_bj1.jpg","right":0,"left":0,"bottom":0}},{"type":"Box","props":{"width":720,"height":1280,"centerY":0,"centerX":0},"child":[{"type":"Image","props":{"x":68,"skin":"ui/loading/tu_di1SP.png","bottom":0}},{"type":"Image","props":{"y":535,"x":75,"skin":"ui/loading/tu_di.png"}},{"type":"Image","props":{"y":225,"x":91,"skin":"ui/loading/tu_logo.png"}}]},{"type":"Box","props":{"width":720,"height":92,"centerX":0,"bottom":79,"anchorY":0.5,"anchorX":0.5},"child":[{"type":"ProgressBar","props":{"width":665,"var":"bar_jd","skin":"ui/loading/progress.png","sizeGrid":"10,20,10,20","height":22,"centerY":20,"centerX":0}},{"type":"Text","props":{"y":53,"x":0,"width":720,"visible":false,"var":"label_jd","text":"0%","strokeColor":"#7c4913","stroke":3,"height":25,"fontSize":20,"color":"#ffffff","align":"center"}},{"type":"Text","props":{"y":22,"x":0,"width":720,"var":"label_Tips","text":"{0}/{1}：正在启动游戏","height":25,"fontSize":22,"color":"#d9d9d9","bold":true,"align":"center"}},{"type":"Effect_tx","props":{"y":41,"x":-79,"var":"eff_bar","blendMode":"lighter","runtime":"ui.qpapi.dating.Effect_txUI"}}]},{"type":"Label","props":{"width":720,"var":"txt_ad","text":"听说下雨天打牌更配哦","height":38,"fontSize":18,"color":"#d9d9d9","centerX":0,"bottom":24,"bold":true,"align":"center"}}]}]};
        constructor(){ super()}
        createChildren():void {
        			View.regComponent("Text",laya.display.Text);
			View.regComponent("ui.qpapi.dating.Effect_txUI",ui.qpapi.dating.Effect_txUI);
