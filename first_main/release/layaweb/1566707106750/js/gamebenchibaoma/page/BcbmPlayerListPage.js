...
(function (gamebenchibaoma) {
    var page;
    (function (page) {
        var BcbmPlayerListPage = /** @class */ (function (_super) {
            __extends(BcbmPlayerListPage, _super);
            function BcbmPlayerListPage(v, onOpenFunc, onCloseFunc) {
            ...
            BcbmPlayerListPage.prototype.init = function () {
                this._viewUI = this.createView('game_ui.tongyong.WanJiaLBUI');
                this.addChild(this._viewUI);
            };
            // 页面打开时执行函数
            BcbmPlayerListPage.prototype.onOpen = function () {
            ...
            BcbmPlayerListPage.prototype.renderHandler = function (cell, index) {
                if (cell) {
                    cell.setData(this._game, cell.dataSource);
                }
            };
            BcbmPlayerListPage.prototype.onUpdateUnit = function () {
                var unitList = [];
            ...
            BcbmPlayerListPage.prototype.close = function () {
                if (this._viewUI) {
            ...
            return BcbmPlayerListPage;
        }(game.gui.base.Page));
        page.BcbmPlayerListPage = BcbmPlayerListPage;
        var PlayerItemRender = /** @class */ (function (_super) {
            ...
            PlayerItemRender.prototype.setData = function (game, data) {
                ...
                if (!this._clipNum) {
                    this._clipNum = new BenchibaomaClip(BenchibaomaClip.RANK_FONT2);
                ...
                if (!this._clipMoney) {
                    this._clipMoney = new BenchibaomaClip(BenchibaomaClip.MONEY_FONT2);
...
//# sourceMappingURL=BcbmPlayerListPage.js.map