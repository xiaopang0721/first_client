...
(function (gamehonghei) {
    var page;
    (function (page) {
        var HongheiPlayerListPage = /** @class */ (function (_super) {
            __extends(HongheiPlayerListPage, _super);
            function HongheiPlayerListPage(v, onOpenFunc, onCloseFunc) {
            ...
            HongheiPlayerListPage.prototype.init = function () {
                this._viewUI = this.createView('game_ui.tongyong.WanJiaLBUI');
                this.addChild(this._viewUI);
            };
            // 页面打开时执行函数
            HongheiPlayerListPage.prototype.onOpen = function () {
            ...
            HongheiPlayerListPage.prototype.renderHandler = function (cell, index) {
                if (cell) {
                    cell.setData(this._game, cell.dataSource);
                }
            };
            HongheiPlayerListPage.prototype.onUpdateUnit = function () {
                var unitList = [];
            ...
            HongheiPlayerListPage.prototype.close = function () {
                if (this._viewUI) {
            ...
            return HongheiPlayerListPage;
        }(game.gui.base.Page));
        page.HongheiPlayerListPage = HongheiPlayerListPage;
        var PlayerItemRender = /** @class */ (function (_super) {
            ...
            PlayerItemRender.prototype.setData = function (game, data) {
                ...
                if (!this._clipNum) {
                    this._clipNum = new HongheiClip(HongheiClip.RANK_FONT2);
                ...
                if (!this._clipMoney) {
                    this._clipMoney = new HongheiClip(HongheiClip.MONEY_FONT2);
...
//# sourceMappingURL=HongheiPlayerListPage.js.map