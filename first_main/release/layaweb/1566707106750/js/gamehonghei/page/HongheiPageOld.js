...
(function (gamehonghei) {
    var page;
    (function (page) {
        var STATUS_CONFIG = ["准备中", "游戏开始", "洗牌中", "发牌中", "下注中", "停止下注", "开牌中", "结算中", "结算结果展示", "准备中"];
        var HongheiPageOld = /** @class */ (function (_super) {
            __extends(HongheiPageOld, _super);
            function HongheiPageOld(v, onOpenFunc, onCloseFunc) {
            ...
            // 页面初始化函数
            HongheiPageOld.prototype.init = function () {
            ...
            // 页面打开时执行函数
            HongheiPageOld.prototype.onOpen = function () {
            ...
            //帧心跳
            HongheiPageOld.prototype.update = function (diff) {
                if (this._hongheiHudMgr) {
                    this._hongheiHudMgr.update(diff);
                }
                this.onTime();
            };
            HongheiPageOld.prototype.onUpdateMapinfo = function () {
            ...
            HongheiPageOld.prototype.onTime = function () {
            ...
            HongheiPageOld.prototype.onBtnTweenEnd = function (e, target) {
            ...
            HongheiPageOld.prototype.close = function () {
                this._player = null;
                if (this._viewUI) {
            ...
            return HongheiPageOld;
        }(game.gui.base.Page));
        page.HongheiPageOld = HongheiPageOld;
    })(page = gamehonghei.page || (gamehonghei.page = {}));
})(gamehonghei || (gamehonghei = {}));
//# sourceMappingURL=HongheiPageOld.js.map