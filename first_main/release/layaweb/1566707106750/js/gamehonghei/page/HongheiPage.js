...
(function (gamehonghei) {
    var page;
    (function (page) {
        var HongheiPage = /** @class */ (function (_super) {
            __extends(HongheiPage, _super);
            function HongheiPage(v, onOpenFunc, onCloseFunc) {
            ...
            // 页面初始化函数
            HongheiPage.prototype.init = function () {
                ...
                var textureTypes = {
                    "R": Path_game_honghei.ui_honghei + "tu_g1.png",
                    "B": Path_game_honghei.ui_honghei + "tu_x1.png",
            ...
            // 页面打开时执行函数
            HongheiPage.prototype.onOpen = function () {
                ...
                this._viewUI.view.onOpen(this._game, page.HongheiPageDef.GAME_NAME);
            ...
            //帧心跳
            HongheiPage.prototype.update = function (diff) {
                if (this._hongheiHudMgr) {
                    this._hongheiHudMgr.update(diff);
                }
                this.onTime();
            };
            HongheiPage.prototype.onUpdateMapinfo = function () {
                var data = this._hongheiHudMgr.data;
            ...
            HongheiPage.prototype.onTime = function () {
                if (!this._hongheiHudMgr || !this._hongheiHudMgr.data || !this._hongheiHudMgr.data.length)
                    return;
                var data = this._hongheiHudMgr.data;
                for (var i = 0; i < this._listState.length; i++) {
            ...
            HongheiPage.prototype.onBtnTweenEnd = function (e, target) {
                ...
                switch (target) {
                    ...
                    case this._viewUI.box0:
                        this._game.sceneObjectMgr.intoStory(page.HongheiPageDef.GAME_NAME, Web_operation_fields.GAME_ROOM_CONFIG_HHDZ_1.toString(), true);
                        break;
                    //小资场	
                    case this._viewUI.box1:
                        this._game.sceneObjectMgr.intoStory(page.HongheiPageDef.GAME_NAME, Web_operation_fields.GAME_ROOM_CONFIG_HHDZ_2.toString(), true);
                        break;
                    //老板场	
                    case this._viewUI.box2:
                        this._game.sceneObjectMgr.intoStory(page.HongheiPageDef.GAME_NAME, Web_operation_fields.GAME_ROOM_CONFIG_HHDZ_3.toString(), true);
                        break;
                    //富豪场	
                    case this._viewUI.box3:
                        this._game.sceneObjectMgr.intoStory(page.HongheiPageDef.GAME_NAME, Web_operation_fields.GAME_ROOM_CONFIG_HHDZ_4.toString(), true);
                        break;
                    case this._viewUI.btn_join:
                        var maplv = TongyongUtil.getJoinMapLv(page.HongheiPageDef.GAME_NAME, this._playerInfo.money);
                        if (!maplv)
                            return;
                        this._game.sceneObjectMgr.intoStory(page.HongheiPageDef.GAME_NAME, maplv.toString(), true);
                        break;
                    default:
                        break;
                }
            };
            HongheiPage.prototype.close = function () {
                this._player = null;
                if (this._viewUI) {
            ...
            HongheiPage.BET_TIME = 15; //下注时长
            return HongheiPage;
        }(game.gui.base.Page));
        page.HongheiPage = HongheiPage;
    })(page = gamehonghei.page || (gamehonghei.page = {}));
})(gamehonghei || (gamehonghei = {}));
//# sourceMappingURL=HongheiPage.js.map