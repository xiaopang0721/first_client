...
(function (gamelonghu) {
    var page;
    (function (page) {
        var LonghuPlayerListPage = /** @class */ (function (_super) {
            __extends(LonghuPlayerListPage, _super);
            function LonghuPlayerListPage(v, onOpenFunc, onCloseFunc) {
            ...
            LonghuPlayerListPage.prototype.init = function () {
                this._viewUI = this.createView('game_ui.tongyong.WanJiaLBUI');
                this.addChild(this._viewUI);
            };
            // 页面打开时执行函数
            LonghuPlayerListPage.prototype.onOpen = function () {
            ...
            LonghuPlayerListPage.prototype.renderHandler = function (cell, index) {
                if (cell) {
                    cell.setData(this._game, cell.dataSource);
                }
            };
            LonghuPlayerListPage.prototype.onUpdateUnit = function () {
                var unitList = [];
            ...
            LonghuPlayerListPage.prototype.close = function () {
                if (this._viewUI) {
            ...
            return LonghuPlayerListPage;
        }(game.gui.base.Page));
        page.LonghuPlayerListPage = LonghuPlayerListPage;
...
//# sourceMappingURL=LonghuPlayerListPage.js.map