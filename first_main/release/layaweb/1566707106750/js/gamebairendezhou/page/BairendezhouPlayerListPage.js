...
(function (gamebairendezhou) {
    var page;
    (function (page) {
        var BairendezhouPlayerListPage = /** @class */ (function (_super) {
            __extends(BairendezhouPlayerListPage, _super);
            function BairendezhouPlayerListPage(v, onOpenFunc, onCloseFunc) {
            ...
            BairendezhouPlayerListPage.prototype.init = function () {
                this._viewUI = this.createView('game_ui.tongyong.WanJiaLBUI');
                this.addChild(this._viewUI);
            };
            // 页面打开时执行函数
            BairendezhouPlayerListPage.prototype.onOpen = function () {
            ...
            BairendezhouPlayerListPage.prototype.renderHandler = function (cell, index) {
                if (cell) {
                    cell.setData(this._game, cell.dataSource);
                }
            };
            BairendezhouPlayerListPage.prototype.onUpdateUnit = function () {
                var unitList = [];
            ...
            BairendezhouPlayerListPage.prototype.close = function () {
                if (this._viewUI) {
            ...
            return BairendezhouPlayerListPage;
        }(game.gui.base.Page));
        page.BairendezhouPlayerListPage = BairendezhouPlayerListPage;
        var PlayerItemRender = /** @class */ (function (_super) {
            ...
            PlayerItemRender.prototype.setData = function (game, data) {
                ...
                if (!this._clipNum) {
                    this._clipNum = new BairendezhouiClip(BairendezhouiClip.RANK_FONT2);
                ...
                if (!this._clipMoney) {
                    this._clipMoney = new BairendezhouiClip(BairendezhouiClip.MONEY_FONT2);
...
//# sourceMappingURL=BairendezhouPlayerListPage.js.map