...
(function (gamebairendezhou) {
    ...
    (function (page) {
        ...
        var BairendezhouPageOld = /** @class */ (function (_super) {
            __extends(BairendezhouPageOld, _super);
            function BairendezhouPageOld(v, onOpenFunc, onCloseFunc) {
            ...
            // 页面初始化函数
            BairendezhouPageOld.prototype.init = function () {
            ...
            // 页面打开时执行函数
            BairendezhouPageOld.prototype.onOpen = function () {
            ...
            //帧心跳
            BairendezhouPageOld.prototype.update = function (diff) {
                if (this._bairendezhouHudMgr) {
                    this._bairendezhouHudMgr.update(diff);
                }
                this.onTime();
            };
            BairendezhouPageOld.prototype.onUpdateMapinfo = function () {
            ...
            BairendezhouPageOld.prototype.onTime = function () {
            ...
            BairendezhouPageOld.prototype.onBtnTweenEnd = function (e, target) {
            ...
            BairendezhouPageOld.prototype.close = function () {
                this._player = null;
                if (this._viewUI) {
            ...
            return BairendezhouPageOld;
        }(game.gui.base.Page));
        page.BairendezhouPageOld = BairendezhouPageOld;
    })(page = gamebairendezhou.page || (gamebairendezhou.page = {}));
})(gamebairendezhou || (gamebairendezhou = {}));
//# sourceMappingURL=BairendezhouPageOld.js.map