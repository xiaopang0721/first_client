...
(function (gameelslp) {
    var page;
    (function (page) {
        var ElslpPlayerListPage = /** @class */ (function (_super) {
            __extends(ElslpPlayerListPage, _super);
            function ElslpPlayerListPage(v, onOpenFunc, onCloseFunc) {
            ...
            ElslpPlayerListPage.prototype.init = function () {
                this._viewUI = this.createView('game_ui.tongyong.WanJiaLBUI');
                this.addChild(this._viewUI);
            };
            // 页面打开时执行函数
            ElslpPlayerListPage.prototype.onOpen = function () {
            ...
            ElslpPlayerListPage.prototype.renderHandler = function (cell, index) {
                if (cell) {
                    cell.setData(this._game, cell.dataSource);
                }
            };
            ElslpPlayerListPage.prototype.onUpdateUnit = function () {
                var unitList = [];
            ...
            ElslpPlayerListPage.prototype.close = function () {
                if (this._viewUI) {
            ...
            return ElslpPlayerListPage;
        }(game.gui.base.Page));
        page.ElslpPlayerListPage = ElslpPlayerListPage;
        var PlayerItemRender = /** @class */ (function (_super) {
            ...
            PlayerItemRender.prototype.setData = function (game, data) {
                ...
                if (!this._clipNum) {
                    this._clipNum = new ElslpClip(ElslpClip.RANK_FONT2);
                ...
                if (!this._clipMoney) {
                    this._clipMoney = new ElslpClip(ElslpClip.MONEY_FONT2);
        ...
        }(ui.nqp.game_ui.tongyong.WanJiaUI));
    })(page = gameelslp.page || (gameelslp.page = {}));
})(gameelslp || (gameelslp = {}));
//# sourceMappingURL=ElslpPlayerListPage.js.map