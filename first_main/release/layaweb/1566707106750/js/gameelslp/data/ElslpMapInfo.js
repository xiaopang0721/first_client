...
(function (gameelslp) {
    ...
    (function (data) {
        ...
        var ElslpMapInfo = /** @class */ (function (_super) {
            __extends(ElslpMapInfo, _super);
            function ElslpMapInfo(v) {
                return _super.call(this, v, function () { return new gamecomponent.object.MapInfoLogObject(); }) || this;
            }
            //当对象更新发生时
            ElslpMapInfo.prototype.onUpdate = function (flags, mask, strmask) {
            ...
            ElslpMapInfo.prototype.getBattleInfoToString = function () {
            ...
            ElslpMapInfo.prototype.getBattleStrByArr = function (arr, title, num) {
                if (num === void 0) { num = 3; }
                var str = "";
            ...
            //地图状态变更
            ElslpMapInfo.EVENT_STATUS_CHECK = "ElslpMapInfo.EVENT_STATUS_CHECK";
            //战斗体更新
            ElslpMapInfo.EVENT_BATTLE_CHECK = "ElslpMapInfo.EVENT_BATTLE_CHECK";
            //继续游戏状态
            ElslpMapInfo.EVENT_STATUS_CONTINUE = "ElslpMapInfo.EVENT_STATUS_CONTINUE";
            //牌局号
            ElslpMapInfo.EVENT_GAME_NO = "ElslpMapInfo.EVENT_GAME_NO";
            //倒计时时间戳更新
            ElslpMapInfo.EVENT_COUNT_DOWN = "ElslpMapInfo.EVENT_COUNT_DOWN";
            //游戏记录更新
            ElslpMapInfo.EVENT_GAME_RECORD = "ElslpMapInfo.EVENT_GAME_RECORD";
            //入座列表更新
            ElslpMapInfo.EVENT_SEATED_LIST = "ElslpMapInfo.EVENT_SEATED_LIST";
            //本局中奖区域更新
            ElslpMapInfo.EVENT_BET_WIN_AREA = "ElslpMapInfo.EVENT_BET_WIN_AREA";
            return ElslpMapInfo;
        }(gamecomponent.object.MapInfoT));
        data.ElslpMapInfo = ElslpMapInfo;
    })(data = gameelslp.data || (gameelslp.data = {}));
})(gameelslp || (gameelslp = {}));
//# sourceMappingURL=ElslpMapInfo.js.map