...
(function (gamebaijiale) {
    var page;
    (function (page) {
        var BaijialeResultPage = /** @class */ (function (_super) {
            __extends(BaijialeResultPage, _super);
            function BaijialeResultPage(v, onOpenFunc, onCloseFunc) {
            ...
            // 页面初始化函数
            BaijialeResultPage.prototype.init = function () {
                this._viewUI = this.createView('game_ui.baijiale.YingUI');
                this.addChild(this._viewUI);
            };
            // 页面打开时执行函数
            BaijialeResultPage.prototype.onOpen = function () {
            ...
            BaijialeResultPage.prototype.onPlayComplte = function () {
                this.close();
            };
            BaijialeResultPage.prototype.close = function () {
                if (this._viewUI) {
            ...
            return BaijialeResultPage;
        }(game.gui.base.Page));
        page.BaijialeResultPage = BaijialeResultPage;
    })(page = gamebaijiale.page || (gamebaijiale.page = {}));
})(gamebaijiale || (gamebaijiale = {}));
//# sourceMappingURL=BaijialeResultPage.js.map