...
(function (gameddz) {
    ...
    (function (page_1) {
        ...
        var MAX_COUNT = 3; //最大人数
        var DdzMapPage = /** @class */ (function (_super) {
            __extends(DdzMapPage, _super);
            function DdzMapPage(v, onOpenFunc, onCloseFunc) {
                ...
                _this._imgTimePos = [[250, 490], [1040, 230], [250, 230]]; //时钟位置
                _this._chooseCards = []; //选中的牌
                _this._surplusCards = [17, 17, 17]; //各个座位剩余牌数
                _this._headPos = [[33, 553], [1160, 197], [27, 197]]; //各个头像坐标
                _this._qiangCount = 0; //抢关次数
                _this._isPlayXiPai = false; //是否播放洗牌
                _this._totalMul = 0; //倍数
                _this._diZhuSeat = 0; //地主
            ...
            // 页面初始化函数
            DdzMapPage.prototype.init = function () {
                ...
                if (!this._ddzMgr) {
                    if (this._game.sceneObjectMgr.story instanceof DdzStory) {
                        this._ddzStory = this._game.sceneObjectMgr.story;
                    }
            ...
            // 页面打开时执行函数
            DdzMapPage.prototype.onOpen = function () {
            ...
            DdzMapPage.prototype.onWashCardOver = function () {
                var _this = this;
            ...
            DdzMapPage.prototype.playDealAni = function () {
            ...
            Object.defineProperty(DdzMapPage.prototype, "isCardRoomType", {
                get: function () {
                    return this._ddzStory instanceof gamecomponent.story.StoryRoomCardBase;
                },
                enumerable: true,
                configurable: true
            });
            //打开时要处理的东西
            DdzMapPage.prototype.updateViewUI = function () {
                ...
                this._viewUI.view_chuntian.visible = false;
            ...
            //按钮点击
            DdzMapPage.prototype.onBtnTweenEnd = function (e, target) {
                var _this = this;
                switch (target) {
                    ...
                    case this._viewUI.btn_cardtype:
                        this._game.uiRoot.general.open(page_1.DdzPageDef.PAGE_DDZ_RULE, function (page) {
                            page.dataSource = 1;
                        });
                        break;
                    case this._viewUI.btn_rules:
                        this._game.uiRoot.general.open(page_1.DdzPageDef.PAGE_DDZ_RULE);
                        break;
                    ...
                    case this._viewUI.btn_record:
                        this._game.uiRoot.general.open(TongyongPageDef.PAGE_TONGYONG_RECORD, function (page) {
                            page.dataSource = {
                                gameid: page_1.DdzPageDef.GAME_NAME,
                    ...
                    case this._viewUI.view_cardroom.btn_invite: //房卡邀请
                        ...
                        if (this.isCardRoomType && this._mapInfo.GetCardRoomId()) {
                            this._game.network.call_get_roomcard_share(page_1.DdzPageDef.GAME_NAME);
                        }
                        break;
                    ...
                    case this._viewUI.btn_chupai:
                        if (this._chooseCards.length == 0)
                            return;
                        var type = this._ddzMgr.checkCardsType(this._chooseCards);
                        if (type == 0) {
            ...
            DdzMapPage.prototype.onSucessHandler = function (data) {
                if (data.code == Web_operation_fields.CLIENT_IRCODE_GET_ROOMCARD_SHARE) {
                    if (data && data.success == 0) {
                        var img_url = data.msg.img_url;
                        var wx_context = data.msg.context || DdzMgr.WXSHARE_DESC;
                        var wx_title = data.msg.title + this._mapInfo.GetCardRoomId() || StringU.substitute(DdzMgr.WXSHARE_TITLE, this._mapInfo.GetCardRoomId());
                        this._game.wxShareUrl(wx_title, wx_context, img_url);
                    }
                }
            };
            //点击任意地方关闭菜单
            DdzMapPage.prototype.onMouseClick = function (e) {
                if (e.currentTarget != this._viewUI.btn_menu) {
                    this._viewUI.img_menu.visible = false;
                    this._viewUI.btn_menu.visible = true;
                }
            };
            DdzMapPage.prototype.onUnitAdd = function (u) {
                this.onUpdateUnit();
            };
            //玩家出去了
            DdzMapPage.prototype.onUnitRemove = function (u) {
                this.onUpdateUnit();
            };
            //精灵显示
            DdzMapPage.prototype.onUpdateUnit = function (qifu_index) {
                var _this = this;
                var mapinfo = this._game.sceneObjectMgr.mapInfo;
                if (!mapinfo)
                    return;
                ...
                var _loop_1 = function (index) {
                    ...
                    if (unit) {
                        ...
                        if (unit.GetIdentity() == 1) {
                            ...
                            if (posIdx == idx) {
                                this_1._viewUI.btn_tuoguan.skin = Path_game_ddz.ui_ddz + "btn_tg1.png";
                            }
                        }
                        else if (unit.GetIdentity() == 0) {
                            this_1._viewUI["view_player" + index].img_tuoguan.visible = false;
                            if (posIdx == idx) {
                                this_1._viewUI.btn_tuoguan.skin = Path_game_ddz.ui_ddz + "btn_tg0.png";
                            }
                        }
                        //头像框
            ...
            DdzMapPage.prototype.playTween = function (img, index, isTween) {
                if (!img)
                    return;
            ...
            //地图监听
            DdzMapPage.prototype.onUpdateMapInfo = function () {
                var mapInfo = this._game.sceneObjectMgr.mapInfo;
            ...
            //假精灵数据
            DdzMapPage.prototype.onUpdateUnitOffline = function () {
                if (!this._ddzMgr.unitOffline)
                    return;
                var unitOffline = this._ddzMgr.unitOffline;
            ...
            //隐藏房卡模式UI
            DdzMapPage.prototype.updateCardRoomDisplayInfo = function () {
                if (!this._mapInfo)
                    return;
            ...
            // 房卡按纽及状态
            DdzMapPage.prototype.setCardRoomBtnVisible = function () {
            ...
            // 房卡事件和初始界面布局
            DdzMapPage.prototype.setCardRoomBtnEvent = function (isOn) {
            ...
            // 是否可以提前终止游戏
            DdzMapPage.prototype.canEndCardGame = function () {
                if (this._isPlaying) {
            ...
            // 游戏结束 场景恢复
            DdzMapPage.prototype.setGameEnd = function () {
                this._viewUI.view_cardroom.visible = false;
                this._viewUI.text_cardroomid.visible = false;
            ...
            //地图状态
            DdzMapPage.prototype.onUpdateMapState = function () {
                if (!this._mapInfo)
                    return;
                var mainUnit = this._game.sceneObjectMgr.mainUnit;
                if (!mainUnit)
                ...
                this._viewUI.view_paixie.cards.visible = state >= 3 /* MAP_STATE_SHUFFLE */ && state < 11 /* MAP_STATE_END */;
                if (this.isCardRoomType) {
                ...
                if (state == 3 /* MAP_STATE_SHUFFLE */) {
                    this._pageHandle.pushClose({ id: page_1.DdzPageDef.PAGE_DDZ_CARDROOM_SETTLE, parent: this._game.uiRoot.HUD });
                    this.playDealAni();
                }
                if (state >= 5 /* MAP_STATE_DEAL_END */) {
                    ...
                    var preSkin = Path_game_ddz.ui_ddz + "tu_x.png";
                    var postSkin = Path_game_ddz.ui_ddz + "tu_b.png";
                    var multiple = this._totalMul == 0 ? 1 : this._totalMul;
                    this._multipleClip.setText(multiple + "", true, false, preSkin, postSkin);
                }
                if (state == 6 /* MAP_STATE_DIZHU */) {
                    if (betPos == mainIdx) {
                ...
                if (state == 7 /* MAP_STATE_PLAYING */) {
                    ...
                    var posIdx = (betPos - mainIdx + MAX_COUNT) % MAX_COUNT;
            ...
            //打开结算界面
            DdzMapPage.prototype.openSettlePage = function () {
                ...
                for (var i = 1; i < 5; i++) {
                    ...
                    var posIdx = (i - this._mainIdx + MAX_COUNT) % MAX_COUNT;
                ...
                this._pageHandle.pushOpen({ id: page_1.DdzPageDef.PAGE_DDZ_CARDROOM_SETTLE, dataSource: infoTemps, parent: this._game.uiRoot.HUD });
            };
            //更新倒计时时间戳
            DdzMapPage.prototype.updateCountDown = function () {
                var mapinfo = this._game.sceneObjectMgr.mapInfo;
            ...
            //操作倒计时
            DdzMapPage.prototype.deltaUpdate = function () {
                if (!(this._game.sceneObjectMgr.mapInfo instanceof DdzMapInfo))
                    return;
                if (!this._viewUI)
                    return;
                var mainUnit = this._game.sceneObjectMgr.mainUnit;
                ...
                if (this._mainIdx == 0)
                    return;
                if (this._curStatus != 7 /* MAP_STATE_PLAYING */ && this._curStatus != 6 /* MAP_STATE_DIZHU */) {
                    this._viewUI.view_time.visible = false;
                    this._viewUI.view_time.ani1.gotoAndStop(24);
                    return;
                }
                var betPos = this._mapInfo.GetCurrentBetPos();
                var posIdx = (betPos - this._mainIdx + MAX_COUNT) % MAX_COUNT;
            ...
            DdzMapPage.prototype.updateBattledInfo = function () {
                ...
                for (var i = 0; i < battleInfoMgr.info.length; i++) {
                    ...
                    var posIdx = (battleInfo.SeatIndex - mainIdx + MAX_COUNT) % MAX_COUNT;
                    switch (battleInfo.Type) {
                                ...
                                if (!this._ddzMgr.isReLogin) {
                                    ...
                                    if (unit) {
                                        ...
                                        if (this._totalMul == 0) {
                                            ...
                                            var musicType = MathU.randomRange(1, 2);
                        ...
                        case 12: { //春天
                            if (this._battleIndex < i) {
                                ...
                                var info = battleInfoMgr.info[i];
                                this._totalMul = this._totalMul * 2;
                                this._viewUI.view_chuntian.visible = true;
                                this._viewUI.view_chuntian.ani1.play(1, false);
                                if (!this._ddzMgr.isReLogin) {
            ...
            //重连之后，战斗日志从哪开始刷
            DdzMapPage.prototype.resetBattleIdx = function () {
                //不是房卡模式，就不用算
                if (!this.isCardRoomType)
                    return;
                var battleInfoMgr = this._mapInfo.battleInfoMgr;
            ...
            //出牌判断
            DdzMapPage.prototype.checkPlayCard = function (type, length, val) {
            ...
            //点牌
            DdzMapPage.prototype.onClickCards = function (hitAvatar) {
            ...
            //点击第二张和第四张联想出三带二和飞机
            DdzMapPage.prototype.ClickCardRelevance = function () {
                //只有点出第二张和第四张才会有
                var length = this._chooseCards.length;
                if (length != 2)
                    return;
                var szTemp = this._ddzMgr.findShunZi(this._ddzMgr.allCards);
                var copyCards = [];
                this._ddzMgr.copyTalbe(this._ddzMgr.allCards, copyCards);
                //选中的牌必须是单张
                var temp = this._ddzMgr.findDuiZi(copyCards);
                var isExist;
                for (var i = 0; i < this._chooseCards.length; i++) {
                    isExist = false;
                ...
                if (length == 2) {
                    if (existCount == 2)
                        return; //在同一个顺子里
                    var stTemp = this._ddzMgr.findSanZhang(cards);
                    if (stTemp.length != 1)
                        return; //只有一个三条的时候，才需要联想
                    if (stTemp[0].length != 3)
                        return; //这个是炸弹
                    for (var i_2 = 0; i_2 < stTemp[0].length; i_2++) {
                        for (var k_2 = 0; k_2 < this._ddzMgr.allCards.length; k_2++) {
                            var card = this._ddzMgr.allCards[k_2];
            ...
            //滑动选牌
            DdzMapPage.prototype.onChooseCards = function () {
                this._chooseCards = [];
                var mainIdx = this._game.sceneObjectMgr.mainUnit.GetIndex();
                //挑出选中的牌
                for (var i = 0; i < this._ddzMgr.allCards.length; i++) {
                    var card = this._ddzMgr.allCards[i];
                    if (card.toggle) {
                        this._chooseCards.push(card);
                        this._ddzMgr.SortCards(this._chooseCards);
                    }
                ...
                //把选中的牌上移
                for (var i = 0; i < this._chooseCards.length; i++) {
                    for (var k = 0; k < this._ddzMgr.allCards.length; k++) {
                        var card = this._ddzMgr.allCards[k];
            ...
            //移动选牌，自由出牌
            DdzMapPage.prototype.FreePlayCard = function (cards) {
                var playCards = [];
                if (playCards.length == 0) { //连对
                    var temp = this._ddzMgr.promptBtn(cards, 8, cards.length, 1, true);
                    if (temp.length > 0) {
                        playCards = temp[0];
                    }
                }
                if (playCards.length == 0) { //顺子
                    var temp1 = this._ddzMgr.findShunZi(cards);
                    if (temp1.length > 0) {
                        playCards = temp1[0];
                    }
                }
            ...
            //提示按钮
            DdzMapPage.prototype.ClickBtnTiShi = function () {
                var mainUnit = this._game.sceneObjectMgr.mainUnit;
                if (!mainUnit)
                    return;
                //先整理下牌
                ...
                if (this._playCardsConfig.card_type == 0 || this._playCardsConfig.player == mainIdx) {
                    if (this._ddzMgr.allCards.length == 0)
                        return;
                    var val = this._ddzMgr.allCards[this._ddzMgr.allCards.length - 1].GetCardVal();
                    var count = 0;
                    for (var i = 0; i < this._ddzMgr.allCards.length; i++) {
                    ...
                    for (var i = 0; i < count; i++) {
                        var card = this._ddzMgr.allCards[this._ddzMgr.allCards.length - (1 + i)];
                        if (!card.toggle) {
                            card.toggle = true;
                            this._chooseCards.push(card);
                            this._ddzMgr.SortCards(this._chooseCards);
                    ...
                    var allcards = this._ddzMgr.promptBtn(this._ddzMgr.allCards, this._playCardsConfig.card_type, this._playCardsConfig.card_len, this._playCardsConfig.max_val, false);
            ...
            //选完牌之后，校验出牌按钮状态
            DdzMapPage.prototype.CheckBtnChuPai = function () {
                var type = this._ddzMgr.checkCardsType(this._chooseCards);
                if (type == 0) {
            ...
            //轮到自己时，按钮状态
            DdzMapPage.prototype.CheckBtnStatus = function (mainIdx) {
                if (this._playCardsConfig.player == mainIdx || this._playCardsConfig.card_type == 0) { //有发牌权
                    ...
                    //手里的牌
                    var cards = this._ddzMgr.promptBtn(this._ddzMgr.allCards, this._playCardsConfig.card_type, this._playCardsConfig.card_len, this._playCardsConfig.max_val, false);
                    ...
                    this._viewUI.img_chupai.visible = true;
                    //选中的牌
                    var choose = this._ddzMgr.promptBtn(this._chooseCards, this._playCardsConfig.card_type, this._playCardsConfig.card_len, this._playCardsConfig.max_val, false);
            ...
            //UI的位置转为座位
            DdzMapPage.prototype.GetSeatFromUiPos = function (pos) {
                var seat = 0;
                var mainIdx = this._game.sceneObjectMgr.mainUnit.GetIndex();
                var posIdx = (pos + mainIdx) % MAX_COUNT;
                seat = posIdx == 0 ? MAX_COUNT : posIdx;
                return seat;
            };
            //飘钱
            DdzMapPage.prototype.addBankerWinEff = function () {
                var mainUnit = this._game.sceneObjectMgr.mainUnit;
                if (!mainUnit)
                    return;
                if (!this._mainIdx)
            ...
            //结算音效
            DdzMapPage.prototype.settleSound = function () {
                var _this = this;
            ...
            //金币变化 飘金币特效
            DdzMapPage.prototype.addMoneyFly = function (fromPos, tarPos) {
            ...
            //倍数显示
            DdzMapPage.prototype.showMultiple = function () {
            ...
            DdzMapPage.prototype.clearMultipleClip = function () {
                if (this._multipleClip) {
            ...
            //金币变化 飘字clip
            DdzMapPage.prototype.addMoneyClip = function (value, pos) {
                var mainUnit = this._game.sceneObjectMgr.mainUnit;
                if (!mainUnit)
                    return;
                var idx = mainUnit.GetIndex();
                if (!idx)
                    return;
                var valueClip = value >= 0 ? new DdzClip(DdzClip.ADD_MONEY_FONT) : new DdzClip(DdzClip.SUB_MONEY_FONT);
                ...
                var index = (pos - idx + MAX_COUNT) % MAX_COUNT;
                ...
                Laya.Tween.to(valueClip, { y: posY - 120 }, 1000);
            };
            //清理飘钱动画
            DdzMapPage.prototype.clearClip = function () {
            ...
            //清理金币
            DdzMapPage.prototype.clearMoneyImg = function () {
            ...
            //算下几个人了
            DdzMapPage.prototype.getUnitCount = function () {
                var count = 0;
            ...
            DdzMapPage.prototype.onOptHandler = function (optcode, msg) {
                var _this = this;
            ...
            //房卡模式，开始游戏
            DdzMapPage.prototype.setCardGameStart = function () {
                var mainUnit = this._game.sceneObjectMgr.mainUnit;
                if (!mainUnit)
                    return;
                var mapinfo = this._game.sceneObjectMgr.mapInfo;
                ...
                if (this.getUnitCount() < MAX_COUNT) {
                    TongyongPageDef.ins.alertRecharge(StringU.substitute("老板，再等等嘛，需要" + MAX_COUNT + "个人才可以开始"), function () {
                    }, function () {
                    }, true, PathGameTongyong.ui_tongyong_general + "btn_qd.png");
                    return;
                }
            ...
            // 房卡模式解散游戏,是否需要房主限制
            DdzMapPage.prototype.masterDismissCardGame = function () {
                var _this = this;
                var mainUnit = this._game.sceneObjectMgr.mainUnit;
                if (!mainUnit)
                    return;
                if (mainUnit.GetRoomMaster() != 1) {
                    ...
                    TongyongPageDef.ins.alertRecharge("游戏未开始，解散房间不会扣除金币！\n是否解散房间？", function () {
                        _this._ddzStory.endRoomCardGame(mainUnit.GetIndex(), _this._mapInfo.GetCardRoomId());
                        _this._game.sceneObjectMgr.leaveStory();
                    }, null, false, PathGameTongyong.ui_tongyong_general + "btn_tx.png");
                }
            };
            //重置数据
            DdzMapPage.prototype.resetData = function () {
                //不是房卡模式，才会去设置
                if (!this.isCardRoomType) {
                    this._battleIndex = -1;
                }
            ...
            DdzMapPage.prototype.clearMapInfoListen = function () {
            ...
            //清理特殊牌效果
            DdzMapPage.prototype.clearCardsView = function () {
            ...
            DdzMapPage.prototype.close = function () {
                if (this._viewUI) {
        ...
        page_1.DdzMapPage = DdzMapPage;
    })(page = gameddz.page || (gameddz.page = {}));
})(gameddz || (gameddz = {}));
//# sourceMappingURL=DdzMapPage.js.map