...
(function (gameddz) {
    var page;
    (function (page_1) {
        var DdzPage = /** @class */ (function (_super) {
            __extends(DdzPage, _super);
            function DdzPage(v, onOpenFunc, onCloseFunc) {
            ...
            // 页面初始化函数
            DdzPage.prototype.init = function () {
            ...
            Object.defineProperty(DdzPage.prototype, "dataSource", {
                /**数据*/
                set: function (v) {
                    this._dataSource = v;
            ...
            // 页面打开时执行函数
            DdzPage.prototype.onOpen = function () {
                _super.prototype.onOpen.call(this);
                this._viewUI.box_normal.visible = !this._isRoomcardType;
                this._viewUI.box_roomcard.visible = this._isRoomcardType;
                this._viewUI.view_hud.onOpen(this._game, page_1.DdzPageDef.GAME_NAME, this._isRoomcardType);
            ...
            DdzPage.prototype.onBtnTweenEnd = function (e, target) {
                ...
                switch (target) {
                    case this._viewUI.img_room_create:
                        this._game.uiRoot.general.open(page_1.DdzPageDef.PAGE_DDZ_CREATE_CARDROOM);
                        break;
                    case this._viewUI.img_room_join:
                        this._game.uiRoot.general.open(page_1.DdzPageDef.PAGE_DDZ_JOIN_CARDROOM);
                        break;
                    default:
                        break;
                }
            };
            DdzPage.prototype.chkPlayerIsGuest = function () {
                var _this = this;
                var result = false;
            ...
            DdzPage.prototype.close = function () {
                if (this._viewUI) {
        ...
        page_1.DdzPage = DdzPage;
    })(page = gameddz.page || (gameddz.page = {}));
})(gameddz || (gameddz = {}));
//# sourceMappingURL=DdzPage.js.map