...
(function (gameshuiguoji) {
    var ClipUtil = /** @class */ (function (_super) {
        ...
        ClipUtil.init = function () {
            this.SGJ_BET_SCORE = {
                ...
                url: Path_game_shuiguoji.ui_shuiguoji + 'clip_cdx.png',
                clipWidth: 22,
                clipHeight: 32,
                clipX: 11,
                space: -4,
            ...
            this.SGJ_GOLD = {
                source: Path_game_shuiguoji.atlas_game_ui + "shuiguoji.atlas",
                url: Path_game_shuiguoji.ui_shuiguoji + 'clip_jb2.png',
                clipWidth: 18.27,
                clipHeight: 23,
                clipX: 11,
                space: 0,
            ...
            this.SGJ_PRIZE_GOLD = {
                source: Path_game_shuiguoji.atlas_game_ui + "shuiguoji.atlas",
                url: Path_game_shuiguoji.ui_shuiguoji + 'clip_jb1.png',
                clipWidth: 46,
                clipHeight: 48,
                clipX: 10,
                space: 0,
    ...
    gameshuiguoji.ClipUtil = ClipUtil;
