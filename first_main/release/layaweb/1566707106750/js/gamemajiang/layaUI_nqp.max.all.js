    ...
    (function (nqp) {
        ...
        (function (game_ui) {
            ...
            (function (sichuanmajiang) {
                var component;
                (function (component) {
                    var btn_2UI = /** @class */ (function (_super) {
                        __extends(btn_2UI, _super);
                        function btn_2UI() {
                            return _super.call(this) || this;
                        }
                        btn_2UI.prototype.createChildren = function () {
                            _super.prototype.createChildren.call(this);
                            this.createView(ui.nqp.game_ui.sichuanmajiang.component.btn_2UI.uiView);
                        };
                        btn_2UI.uiView = { "type": "View", "props": { "width": 100, "height": 100 }, "child": [{ "type": "Button", "props": { "stateNum": 1, "skin": "majiang_ui/game_ui/sichuanmajiang/btn_tt.png", "centerY": 0, "centerX": 0, "anchorY": 0.5, "anchorX": 0.5 } }, { "type": "Image", "props": { "y": 50, "x": 50, "skin": "majiang_ui/game_ui/sichuanmajiang/btn_tt.png", "blendMode": "lighter", "anchorY": 0.5, "anchorX": 0.5 }, "compId": 4 }], "animations": [{ "nodes": [{ "target": 4, "keyframes": { "scaleY": [{ "value": 1, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "scaleY", "index": 0 }, { "value": 1.2, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "scaleY", "index": 10 }], "scaleX": [{ "value": 1, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "scaleX", "index": 0 }, { "value": 1.2, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "scaleX", "index": 10 }], "alpha": [{ "value": 0.5, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "alpha", "index": 0 }, { "value": 0, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "alpha", "index": 10 }] } }], "name": "ani1", "id": 1, "frameRate": 24, "action": 2 }] };
                        return btn_2UI;
                    }(View));
                    component.btn_2UI = btn_2UI;
                })(component = sichuanmajiang.component || (sichuanmajiang.component = {}));
            })(sichuanmajiang = game_ui.sichuanmajiang || (game_ui.sichuanmajiang = {}));
        })(game_ui = nqp.game_ui || (nqp.game_ui = {}));
    })(nqp = ui.nqp || (ui.nqp = {}));
    ...
    (function (nqp) {
        ...
        (function (game_ui) {
            ...
            (function (sichuanmajiang) {
                var component;
                (function (component) {
                    var btn_3UI = /** @class */ (function (_super) {
                        __extends(btn_3UI, _super);
                        function btn_3UI() {
                            return _super.call(this) || this;
                        }
                        btn_3UI.prototype.createChildren = function () {
                            _super.prototype.createChildren.call(this);
                            this.createView(ui.nqp.game_ui.sichuanmajiang.component.btn_3UI.uiView);
                        };
                        btn_3UI.uiView = { "type": "View", "props": { "width": 100, "height": 100 }, "child": [{ "type": "Button", "props": { "stateNum": 1, "skin": "majiang_ui/game_ui/sichuanmajiang/btn_w.png", "centerY": 0, "centerX": 0, "anchorY": 0.5, "anchorX": 0.5 } }, { "type": "Image", "props": { "y": 50, "x": 50, "skin": "majiang_ui/game_ui/sichuanmajiang/btn_w.png", "blendMode": "lighter", "anchorY": 0.5, "anchorX": 0.5 }, "compId": 4 }], "animations": [{ "nodes": [{ "target": 4, "keyframes": { "scaleY": [{ "value": 1, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "scaleY", "index": 0 }, { "value": 1.2, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "scaleY", "index": 10 }], "scaleX": [{ "value": 1, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "scaleX", "index": 0 }, { "value": 1.2, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "scaleX", "index": 10 }], "alpha": [{ "value": 0.5, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "alpha", "index": 0 }, { "value": 0, "tweenMethod": "linearNone", "tween": true, "target": 4, "key": "alpha", "index": 10 }] } }], "name": "ani1", "id": 1, "frameRate": 24, "action": 2 }] };
                        return btn_3UI;
                    }(View));
                    component.btn_3UI = btn_3UI;
                })(component = sichuanmajiang.component || (sichuanmajiang.component = {}));
            })(sichuanmajiang = game_ui.sichuanmajiang || (game_ui.sichuanmajiang = {}));
        })(game_ui = nqp.game_ui || (nqp.game_ui = {}));
    })(nqp = ui.nqp || (ui.nqp = {}));
                ...
                (function (component) {
                    var TouXiangUI = /** @class */ (function (_super) {
                        ...
                        TouXiangUI.prototype.createChildren = function () {
                            ...
                            _super.prototype.createChildren.call(this);
                            this.createView(ui.nqp.game_ui.sichuanmajiang.component.TouXiangUI.uiView);
                        };
    ...
    (function (nqp) {
        ...
        (function (game_ui) {
            ...
            (function (sichuanmajiang) {
                var component;
                (function (component) {
                    var TouXiang1UI = /** @class */ (function (_super) {
                        __extends(TouXiang1UI, _super);
                        function TouXiang1UI() {
                            return _super.call(this) || this;
                        }
                        TouXiang1UI.prototype.createChildren = function () {
                            View.regComponent("Text", laya.display.Text);
                            _super.prototype.createChildren.call(this);
                            this.createView(ui.nqp.game_ui.sichuanmajiang.component.TouXiang1UI.uiView);
                        };
                        TouXiang1UI.uiView = { "type": "View", "props": { "width": 100, "height": 138 }, "child": [{ "type": "Box", "props": { "y": 1, "x": 1 }, "child": [{ "type": "Image", "props": { "y": -7, "x": -5, "skin": "tongyong_ui/game_ui/tongyong/general/tu_txk1.png" } }, { "type": "Image", "props": { "y": 63, "x": 49, "visible": false, "skin": "tongyong_ui/game_ui/tongyong/touxiang/tu_txk.png", "anchorY": 0.5, "anchorX": 0.5 } }, { "type": "Image", "props": { "y": 64, "x": 49, "var": "img_head", "skin": "tongyong_ui/game_ui/tongyong/touxiang/head_0.png", "anchorY": 0.5, "anchorX": 0.5 } }, { "type": "Text", "props": { "y": 6, "x": 0, "wordWrap": true, "width": 100, "var": "text_name", "text": "玩家名字", "leading": 6, "height": 17, "fontSize": 16, "color": "#12093d", "align": "center" } }, { "type": "Text", "props": { "y": 108, "x": -7, "wordWrap": true, "width": 110, "var": "text_money", "text": "0", "leading": 6, "height": 21, "fontSize": 20, "color": "#b18dff", "align": "center" } }, { "type": "Image", "props": { "y": 0, "x": 0, "var": "img_frame", "skin": "tongyong_ui/game_ui/tongyong/general/tu_djs.png" }, "child": [{ "type": "Image", "props": { "y": -3, "x": -3, "width": 104, "var": "img_mask", "renderType": "mask", "height": 142 } }] }] }, { "type": "Image", "props": { "y": 62, "x": 1, "var": "img_type", "skin": "majiang_ui/game_ui/sichuanmajiang/tu_tt.png", "anchorY": 0.5, "anchorX": 0.5 } }] };
                        return TouXiang1UI;
                    }(View));
                    component.TouXiang1UI = TouXiang1UI;
                })(component = sichuanmajiang.component || (sichuanmajiang.component = {}));
            })(sichuanmajiang = game_ui.sichuanmajiang || (game_ui.sichuanmajiang = {}));
        })(game_ui = nqp.game_ui || (nqp.game_ui = {}));
    })(nqp = ui.nqp || (ui.nqp = {}));
...
(function (ui) {
    ...
    (function (nqp) {
        ...
        (function (game_ui) {
            var sichuanmajiang;
            (function (sichuanmajiang) {
                var SiChuanMaJiang_HUDUI = /** @class */ (function (_super) {
                    __extends(SiChuanMaJiang_HUDUI, _super);
                    function SiChuanMaJiang_HUDUI() {
                        return _super.call(this) || this;
                    }
                    SiChuanMaJiang_HUDUI.prototype.createChildren = function () {
                        View.regComponent("ui.nqp.game_ui.tongyong.HudUI", ui.nqp.game_ui.tongyong.HudUI);
                        _super.prototype.createChildren.call(this);
                        this.createView(ui.nqp.game_ui.sichuanmajiang.SiChuanMaJiang_HUDUI.uiView);
                    };
                    SiChuanMaJiang_HUDUI.uiView = { "type": "View", "props": { "width": 1280, "height": 720 }, "child": [{ "type": "Image", "props": { "top": -1, "skin": "majiang_ui/game_ui/sichuanmajiang/zjh.jpg", "right": -140, "left": -140, "bottom": -1 } }, { "type": "Hud", "props": { "var": "view_hud", "top": 0, "right": 0, "left": 0, "bottom": 0, "runtime": "ui.nqp.game_ui.tongyong.HudUI" } }, { "type": "Image", "props": { "top": 6, "skin": "majiang_ui/game_ui/sichuanmajiang/zjh_title.png", "centerX": 126, "anchorY": 0.5, "anchorX": 0.5 } }] };
                    return SiChuanMaJiang_HUDUI;
                }(View));
                sichuanmajiang.SiChuanMaJiang_HUDUI = SiChuanMaJiang_HUDUI;
            })(sichuanmajiang = game_ui.sichuanmajiang || (game_ui.sichuanmajiang = {}));
        })(game_ui = nqp.game_ui || (nqp.game_ui = {}));
    })(nqp = ui.nqp || (ui.nqp = {}));
})(ui || (ui = {}));
