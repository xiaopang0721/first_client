...
(function (gametoubao) {
    var page;
    (function (page) {
        var ToubaoPage = /** @class */ (function (_super) {
            __extends(ToubaoPage, _super);
            function ToubaoPage(v, onOpenFunc, onCloseFunc) {
            ...
            ToubaoPage.prototype.onBtnTweenEnd = function (e, target) {
            ...
            ToubaoPage.prototype.showTipsBox = function (limit) {
                var _this = this;
            ...
            ToubaoPage.prototype.close = function () {
                this._player = null;
                if (this._viewUI) {
        ...
        page.ToubaoPage = ToubaoPage;
    })(page = gametoubao.page || (gametoubao.page = {}));
})(gametoubao || (gametoubao = {}));
//# sourceMappingURL=ToubaoPage.js.map