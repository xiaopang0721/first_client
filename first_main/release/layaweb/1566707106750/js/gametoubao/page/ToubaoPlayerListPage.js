...
(function (gametoubao) {
    var page;
    (function (page) {
        var ToubaoPlayerListPage = /** @class */ (function (_super) {
            __extends(ToubaoPlayerListPage, _super);
            function ToubaoPlayerListPage(v, onOpenFunc, onCloseFunc) {
            ...
            ToubaoPlayerListPage.prototype.init = function () {
                this._viewUI = this.createView('game_ui.tongyong.WanJiaLBUI');
                this.addChild(this._viewUI);
            };
            // 页面打开时执行函数
            ToubaoPlayerListPage.prototype.onOpen = function () {
            ...
            ToubaoPlayerListPage.prototype.renderHandler = function (cell, index) {
                if (cell) {
                    cell.setData(this._game, cell.dataSource);
                }
            };
            ToubaoPlayerListPage.prototype.onUpdateUnit = function () {
                var unitList = [];
            ...
            ToubaoPlayerListPage.prototype.close = function () {
                if (this._viewUI) {
            ...
            return ToubaoPlayerListPage;
        }(game.gui.base.Page));
        page.ToubaoPlayerListPage = ToubaoPlayerListPage;
...
//# sourceMappingURL=ToubaoPlayerListPage.js.map