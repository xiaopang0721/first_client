...
(function (gamedatingnqp) {
    var ClipUtil = /** @class */ (function (_super) {
        ...
        ClipUtil.init = function () {
            this.LUNPAN_FONT = {
                source: DatingPath.atlas_dating_ui + 'zhuanpan.atlas',
                url: DatingPath.ui_dating + 'zhuanpan/clip_jf.png',
                clipWidth: 23,
                clipHeight: 32,
                clipX: 10,
                space: 0
            ...
            this.RANK_FONT2 = {
                source: DatingPath.atlas_dating_ui + "tongyong.atlas",
                url: DatingPath.ui_dating + 'tongyong/clip_top.png',
                clipWidth: 28,
                clipHeight: 31,
                clipX: 10,
                space: 0
            ...
            this.SHARE_FONT = {
                source: DatingPath.atlas_dating_ui + "fenxiang.atlas",
                url: DatingPath.ui_dating + 'fenxiang/clip_dqjj.png',
                clipWidth: 26,
                clipHeight: 35,
                clipX: 11,
                space: 0,
            ...
            this.BIND_FONT = {
                source: DatingPath.atlas_dating_ui + "bangding.atlas",
                url: DatingPath.ui_dating + 'bangding/clip_sz.png',
                clipWidth: 120,
                clipHeight: 160,
                clipX: 10,
                space: -30,
            };
            this.DATING_BIND_FONT = {
                source: DatingPath.atlas_dating_ui + "dating.atlas",
                url: DatingPath.ui_dating + 'dating/clip_sz.png',
                clipWidth: 44,
                clipHeight: 50,
                clipX: 10,
                space: 0,
            ...
            this.TURANBLE_FONT = {
                source: DatingPath.atlas_dating_ui + "zhuanpan.atlas",
                url: DatingPath.ui_dating + 'zhuanpan/clip_jf1.png',
                clipWidth: 25,
                clipHeight: 19,
                clipX: 10,
                space: -6,
            ...
            this.SHOUCHONG_FONT = {
                ...
                url: DatingPath.ui_dating + 'shouchong/clip_sz01.png',
                clipWidth: 78,
                clipHeight: 104,
                clipX: 10,
                space: 0,
    ...
    gamedatingnqp.ClipUtil = ClipUtil;
