...
(function (gamedatingnqp) {
    var DatingGame = /** @class */ (function () {
        ...
        Object.defineProperty(DatingGame.prototype, "hudTabScrollData", {
            get: function () {
                return this._hudTabScrollData = this._hudTabScrollData || new HudTabScrollData();
            },
            enumerable: true,
            configurable: true
        });
        ...
        //app关闭回调
        DatingGame.prototype.update_appCloseCallBack = function (success) {
            //退出弹出提示
            this.quitGame();
        };
        //微信分享回调
        ...
        DatingGame.prototype.wxShareUrl = function (title, description, img_url) {
            var iconUrl = img_url || Laya.URL.formatURL("dating_ui/logo/app_100.png");
        ...
        DatingGame.prototype.wxShareQrcodeImg = function (title, description, scene) {
            ...
            if (!WebConfig.info.mobile) {
                this._game.uiRoot.general.open(DatingPageDef.PAGE_BINDPHONE, function (page) {
            ...
            WebConfig.wxShareQrcodeImg(Laya.URL.formatURL("dating_ui/tuiguang/tu_tg3.jpg"), 405, 720, WebConfig.ewmUrl, 233, 491, 140, 140, title, description, scene - 1);
        ...
        DatingGame.prototype.saveQrcodeImage = function () {
            WebConfig.saveQrcodeImage(Laya.URL.formatURL("dating_ui/tuiguang/tu_tg3.jpg"), 405, 720, WebConfig.ewmUrl, 233, 491, 140, 140);
        };
        /**
         * 微信分享文字
         */
            ...
            if (msg.type == Operation_Fields.OPRATE_GAME) { //游戏操作错误类型
                switch (msg.reason) {
                    ...
                    case Operation_Fields.OPRATE_GAME_BIND_GIFT_SUCCESS: // 绑定送金成功
                        this._game.uiRoot.general.open(DatingPageDef.PAGE_GET_REWARD, function (page) {
        ...
        Object.defineProperty(DatingGame, "FirstAlert", {
            get: function () {
                return this._firstAlert;
            },
            set: function (value) {
                this._firstAlert = value;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(DatingGame, "AlertPageIndex", {
            get: function () {
                return this._alertPageIndex;
            },
            set: function (value) {
                this._alertPageIndex = value;
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(DatingGame.prototype, "popUpData", {
            get: function () {
                if (!this._curData) {
                    this._curData = [];
                }
                ...
                for (var index = 0; index < keys.length; index++) {
                    var key = keys[index];
                    var data_3 = FreeStyle.getData(Web_operation_fields.FREE_STYLE_TYPES_GAMEPOPCONFIG_C, key);
                    if (!data_3)
                        continue;
                    if (this._curData.indexOf(data_3) != -1)
                        continue;
                    this._curData[this._curData.length] = data_3;
                    count++;
                }
                count > 0 && (this._curData = this._curData.sort(function (a, b) {
                    if (!a || !b)
                        return 0;
        ...
        Object.defineProperty(DatingGame.prototype, "curPageKey", {
            get: function () {
                return this._curKey;
            },
            enumerable: true,
        ...
        DatingGame.prototype.firstAlertPage = function () {
            if (!DatingGame.FirstAlert) {
                DatingGame.AlertPageIndex = DatingGame.AlertPageIndex + 1;
                if (!this.popUpData)
                    return;
                var popKeyData = this.popUpData[DatingGame.AlertPageIndex];
                if (!popKeyData) {
                    DatingGame.AlertPageIndex = -1;
                    DatingGame.FirstAlert = true;
                    return;
                }
                var popkey = popKeyData.popkey;
                ...
                if (this._curKey) {
                    ...
                    if (popKeyData.isopen) {
                        if (popkey == "bdsq") {
                            ...
                            if (!mainPlayer)
                                return;
                            var mobile = mainPlayer.playerInfo.mobile;
                            if (mobile) {
                                this.firstAlertPage();
                                return;
                            }
                        ...
                        this._game.uiRoot.general.open(this._curKey);
                    }
                    else {
                        this.firstAlertPage();
                    }
        ...
        //安卓游戏退出二次弹窗确认
        DatingGame.prototype.quitGame = function () {
            if (WebConfig.onAndroid) {
                var quitPage = this._game.uiRoot.general.getPage(DatingPageDef.PAGE_QUIT_TIPS);
                if (quitPage) {
                    //直接退出游戏
        ...
        DatingGame.prototype.checkClientVesion = function (isShowTips) {
            ...
            if ((WebConfig.onAndroid || WebConfig.onIOS) && !WebConfig.after && WebConfig.info && WebConfig.appVersion) {
                ...
                if (app_version_1 && WebConfig.appVersion != app_version_1) {
                    ...
                    if (ch || newbb > oldbb) {
                        var data_4 = {};
                        data_4["invitecode"] = WebConfig.getInviteCode() || "";
                        data_4["is_dan"] = WebConfig.isSingleEnter ? Web_operation_fields.GAME_APP_TYPE_1 : Web_operation_fields.GAME_APP_TYPE_2;
                        var url = WebConfig.gwUrl + (Laya.Browser.onAndroid ? "/game/packAndroid" : "/game/packIos");
                        utils.Request.sendA(url, data_4, Handler.create(this, function (value) {
        ...
        //是否首次登陆游戏
        DatingGame._firstAlert = false;
        //弹框标志位
        DatingGame._alertPageIndex = -1;
        DatingGame.QIPAOKUANGHD = "qipaokuanghd";
        DatingGame.QIPAOKUANGGW = "qipaokuanggw";
        return DatingGame;
    }());
    gamedatingnqp.DatingGame = DatingGame;
    var HudTabScrollData = /** @class */ (function () {
        function HudTabScrollData() {
        }
        return HudTabScrollData;
    }());
