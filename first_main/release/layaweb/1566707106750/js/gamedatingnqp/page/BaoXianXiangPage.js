...
(function (gamedatingnqp) {
    ...
    (function (page) {
        var BaoXianXiangPage = /** @class */ (function (_super) {
            ...
            BaoXianXiangPage.prototype.selectHandler = function (index) {
                if (index == 0) {
                    ...
                    this._viewUI.btn_enter.skin = "dating_ui/baoxianxiang/btn_cr1.png";
                    this._viewUI.box_lixi.visible = true;
                }
                else if (index == 1) {
                    this._viewUI.txt_type.text = "取　出：";
                    this._viewUI.btn_enter.skin = "dating_ui/baoxianxiang/btn_qc1.png";
        ...
        }(ui.nqp.dating.component.BaoXianXiangTUI));
