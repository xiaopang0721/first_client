...
(function (gamedatingnqp) {
    ...
    (function (page_1) {
        var TiQuJiLvPage = /** @class */ (function (_super) {
            ...
            TiQuJiLvPage.prototype.renderHandler = function (cell, index) {
                if (cell) {
                    ...
                    if (!gamedatingnqp.DatingGame.ins.fanYongMgr.dataInfo[page_2]) {
                        if (gamedatingnqp.DatingGame.ins.fanYongMgr.dataInfo[page_2 - 1] && gamedatingnqp.DatingGame.ins.fanYongMgr.dataInfo[page_2 - 1].length >= FanYongMgr.PAGE_MAX) {
                            gamedatingnqp.DatingGame.ins.fanYongMgr.dataInfo[page_2] = {};
                            gamedatingnqp.DatingGame.ins.fanYongMgr.getData(page_2);
                        }
                    }
                }
            };
            ...
            TiQuJiLvPage.prototype.onOpen = function () {
                ...
                gamedatingnqp.DatingGame.ins.fanYongMgr.on(FanYongMgr.EVENT_CHANGE, this, this.onUpdateDataInfo);
                this.onUpdateDataInfo();
            };
            TiQuJiLvPage.prototype.onUpdateDataInfo = function (data) {
                this._dataInfo = [];
                var value = gamedatingnqp.DatingGame.ins.fanYongMgr.dataInfo;
                var count = 0;
                ...
                if (!count) {
                    if (!data)
                        gamedatingnqp.DatingGame.ins.fanYongMgr.getData(1);
                    return;
                }
                for (var key in value) {
        ...
        var FanYongT = /** @class */ (function (_super) {
            ...
            return FanYongT;
        }(ui.nqp.dating.component.FanYongTUI));
