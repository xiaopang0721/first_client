    ...
    (function (page) {
        var GongGaoPage = /** @class */ (function (_super) {
            ...
            GongGaoPage.prototype.onOpen = function () {
                ...
                gamedatingnqp.DatingGame.ins.noticeMgr.on(NoticesMgr.EVENT_CHANGE, this, this.onUpdateNotes);
                this.onUpdateNotes();
            };
            GongGaoPage.prototype.onUpdateNotes = function () {
                if (this._isShowNotice)
                    return;
                var notice = gamedatingnqp.DatingGame.ins.noticeMgr.getNotice();
                if (notice) {
            ...
            GongGaoPage.prototype.close = function () {
                gamedatingnqp.DatingGame.ins.noticeMgr.off(NoticesMgr.EVENT_CHANGE, this, this.onUpdateNotes);
