    ...
    (function (page) {
        ...
        var TipsPage = /** @class */ (function (_super) {
            ...
            TipsPage.prototype.init = function () {
                ...
                this._frames = [{ scaleX: 0.9, scaleY: 0.9, alpha: 0, centerY: 0, centerX: -440 }, { scaleX: 1, scaleY: 1, alpha: 1, centerY: 0, centerX: 0 }, { scaleX: 1, scaleY: 1, alpha: 1, centerY: 0 }, { scaleX: 1, scaleY: 1, alpha: 0, centerY: -67 }];
                this._times = [0, 5, 13, 22];
            };
            // 页面打开时执行函数
