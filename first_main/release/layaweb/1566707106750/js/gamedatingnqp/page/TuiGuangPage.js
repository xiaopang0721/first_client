    ...
    (function (page_1) {
        var TuiGuangPage = /** @class */ (function (_super) {
            ...
            TuiGuangPage.prototype.init = function () {
                ...
                for (var i = 0; i < 7; i++) {
                    this._viewUI["btn" + i].label = this._btnLabel[i];
            ...
            TuiGuangPage.prototype.onUpdateDataInfo = function (data) {
                this._dataInfo = [];
                var value = this._game.datingGame.dailiyonghuMgr.getDataInfo(this._timeSelectIndex);
                var count = 0;
                for (var key in value) {
                    if (value[key] && value[key].length > 0)
                        count++;
                }
                var agencytype = this._game.datingGame.dailiyonghuMgr.agencyType() || this.typeDaiLi;
                ...
                var huizong = this._game.datingGame.dailiyonghuMgr.getDataHuiZong(this._timeSelectIndex);
            ...
            TuiGuangPage.prototype.renderHandlerYH = function (cell, index) {
                if (cell) {
                    ...
                    if (!this._game.datingGame.dailiyonghuMgr.getDataInfo(this._timeSelectIndex)[page_2]) {
                        if (this._game.datingGame.dailiyonghuMgr.getDataInfo(this._timeSelectIndex)[page_2 - 1] && this._game.datingGame.dailiyonghuMgr.getDataInfo(this._timeSelectIndex)[page_2 - 1].length >= DaiLiYongHuMgr.PAGE_MAX) {
                            this._game.datingGame.dailiyonghuMgr.getDataInfo(this._timeSelectIndex)[page_2] = {};
            ...
            TuiGuangPage.prototype.onUpdatePlayerInfo = function () {
                ...
                this._viewUI.txt_gw.text = "http://www.008.com"; //WebConfig.info.gwUrl;
        ...
        var TuiGuangMX = /** @class */ (function (_super) {
            ...
            return TuiGuangMX;
        }(ui.nqp.dating.component.TuiGuangMX_TUI));
        ...
        }(ui.nqp.dating.component.FenXiangT6UI));
        //记录(无限代理)
        ...
        }(ui.nqp.dating.component.FenXiangT5UI));
        //记录(全民代理)
        ...
        }(ui.nqp.dating.component.YongHuTUI));
