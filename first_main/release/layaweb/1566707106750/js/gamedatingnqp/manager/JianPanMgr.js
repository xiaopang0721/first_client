    ...
    (function (managers) {
        var JianPanMgr = /** @class */ (function (_super) {
            ...
            JianPanMgr.prototype.onKeyDown = function (e) {
                ...
                var match;
                var type = this._inputTextUI.inputType;
            ...
            JianPanMgr.prototype.openJianPan = function (textUI, viewUI, centerY) {
                gamedatingnqp.DatingGame.ins.jianPanMgr.inputTextUI = textUI;
                if (!Browser.onPC || WebConfig.isPopJianPan) {
                    gamedatingnqp.DatingGame.ins.jianPanMgr.pageUI = viewUI;
                    gamedatingnqp.DatingGame.ins.jianPanMgr.pageUI.box.centerY = centerY;
                    this._game.uiRoot.top.open(DatingPageDef.PAGE_JIANPAN, function (page) {
                        page.dataSource = textUI.inputType;
                    }, function () {
                        if (gamedatingnqp.DatingGame.ins.jianPanMgr.pageUI && gamedatingnqp.DatingGame.ins.jianPanMgr.pageUI.box) {
                            gamedatingnqp.DatingGame.ins.jianPanMgr.pageUI.box.centerY = 20;
                        }
                    });
                }
            };
