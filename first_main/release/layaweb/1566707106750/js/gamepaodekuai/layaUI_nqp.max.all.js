                ...
                (function (component) {
                    var menuUI = /** @class */ (function (_super) {
                        ...
                        menuUI.prototype.createChildren = function () {
                            _super.prototype.createChildren.call(this);
                            this.createView(ui.nqp.game_ui.paodekuai.component.menuUI.uiView);
                        };
                ...
                (function (component) {
                    var shunziUI = /** @class */ (function (_super) {
                        ...
                        shunziUI.prototype.createChildren = function () {
                            _super.prototype.createChildren.call(this);
                            this.createView(ui.nqp.game_ui.paodekuai.component.shunziUI.uiView);
                        };
                        shunziUI.uiView = { "type": "View", "props": { "width": 1280, "height": 720 }, "child": [{ "type": "Image", "props": { "y": 193, "x": 1289, "skin": "paodekuai_ui/game_ui/paodekuai/effect/shunzi/img_shunzi_1.png" }, "compId": 2 }], "animations": [{ "nodes": [{ "target": 2, "keyframes": { "x": [{ "value": 1289, "tweenMethod": "linearNone", "tween": true, "target": 2, "key": "x", "index": 0 }, { "value": -211, "tweenMethod": "linearNone", "tween": true, "target": 2, "key": "x", "index": 40 }] } }], "name": "ani1", "id": 2, "frameRate": 24, "action": 0 }] };
                        return shunziUI;
                    }(View));
                ...
                (function (component) {
                    var TouXiangUI = /** @class */ (function (_super) {
                        ...
                        TouXiangUI.prototype.createChildren = function () {
                            ...
                            _super.prototype.createChildren.call(this);
                            this.createView(ui.nqp.game_ui.paodekuai.component.TouXiangUI.uiView);
                        };
                        TouXiangUI.uiView = { "type": "View", "props": { "width": 100, "height": 138 }, "child": [{ "type": "Box", "props": { "y": 1, "x": 1 }, "child": [{ "type": "Image", "props": { "y": -7, "x": -5, "skin": "tongyong_ui/game_ui/tongyong/general/tu_txk1.png" } }, { "type": "Image", "props": { "y": 63, "x": 49, "var": "img_head", "skin": "tongyong_ui/game_ui/tongyong/touxiang/head_0.png", "anchorY": 0.5, "anchorX": 0.5 } }, { "type": "Text", "props": { "y": 4, "x": -1, "wordWrap": true, "width": 99, "var": "txt_name", "text": "玩家名字", "leading": 6, "height": 17, "fontSize": 16, "color": "#efda8b", "align": "center" } }, { "type": "Text", "props": { "y": 109, "x": -7, "wordWrap": true, "width": 110, "var": "txt_money", "text": "000000.00", "leading": 6, "height": 22, "fontSize": 20, "color": "#f8ea5e", "align": "center" } }, { "type": "Image", "props": { "y": 27, "x": 13, "visible": false, "var": "img_tuoguan", "skin": "paodekuai_ui/game_ui/paodekuai/tu_tg0.png" } }, { "type": "Image", "props": { "y": 14, "x": 2, "var": "img_txk", "skin": "tongyong_ui/game_ui/tongyong/touxiang/tu_v1.png", "scaleY": 0.95, "scaleX": 0.95 } }, { "type": "Image", "props": { "y": 21, "x": 69, "visible": false, "var": "img_qifu", "skin": "tongyong_ui/game_ui/tongyong/touxiang/tu_qf.png" } }, { "type": "Image", "props": { "y": 105, "x": 50, "visible": false, "var": "qifu_type", "skin": "tongyong_ui/game_ui/tongyong/qifu/f_cs2.png", "scaleY": 0.5, "scaleX": 0.5, "anchorY": 1, "anchorX": 0.5 } }] }] };
                        return TouXiangUI;
                    }(View));
...
(function (ui) {
    ...
    (function (nqp) {
        ...
        (function (game_ui) {
            var paodekuai;
            (function (paodekuai) {
                var PaoDeKuaiUI = /** @class */ (function (_super) {
                    __extends(PaoDeKuaiUI, _super);
                    function PaoDeKuaiUI() {
                        return _super.call(this) || this;
                    }
                    PaoDeKuaiUI.prototype.createChildren = function () {
                        View.regComponent("ui.nqp.game_ui.paodekuai.component.TouXiangUI", ui.nqp.game_ui.paodekuai.component.TouXiangUI);
                        View.regComponent("ui.nqp.game_ui.paodekuai.component.BaoDanUI", ui.nqp.game_ui.paodekuai.component.BaoDanUI);
...
(function (ui) {
    ...
    (function (nqp) {
        ...
        (function (game_ui) {
            var paodekuai;
            (function (paodekuai) {
                var PaoDeKuai_HUDUI = /** @class */ (function (_super) {
                    __extends(PaoDeKuai_HUDUI, _super);
                    function PaoDeKuai_HUDUI() {
                        return _super.call(this) || this;
                    }
                    PaoDeKuai_HUDUI.prototype.createChildren = function () {
                        View.regComponent("ui.nqp.game_ui.tongyong.HudUI", ui.nqp.game_ui.tongyong.HudUI);
                        _super.prototype.createChildren.call(this);
                        this.createView(ui.nqp.game_ui.paodekuai.PaoDeKuai_HUDUI.uiView);
                    };
                    PaoDeKuai_HUDUI.uiView = { "type": "View", "props": { "width": 1280, "top": 24, "height": 720, "centerX": 0 }, "child": [{ "type": "Image", "props": { "top": -1, "skin": "paodekuai_ui/game_ui/paodekuai/zjh.jpg", "right": -140, "left": -140, "bottom": -1 } }, { "type": "Image", "props": { "var": "img_mn", "skin": "paodekuai_ui/game_ui/paodekuai/zjh_rw.png", "left": -100, "bottom": 0, "anchorY": 0.5 } }, { "type": "Hud", "props": { "var": "view_hud", "top": 0, "runtime": "ui.nqp.game_ui.tongyong.HudUI", "right": 0, "left": 0, "bottom": 0 } }, { "type": "Box", "props": { "y": 40, "x": 40, "width": 910, "var": "box_normal", "top": 0, "right": 0, "bottom": 0, "anchorY": 0.5, "anchorX": 0.5 }, "child": [{ "type": "Box", "props": { "width": 1186, "var": "box_right", "height": 465, "centerY": 20, "centerX": -190, "anchorY": 0.5, "anchorX": 0.5 }, "child": [{ "type": "Image", "props": { "y": 232, "var": "img_room0", "skin": "tongyong_ui/game_ui/tongyong/hud/difen_00.png", "right": 890, "name": "item0", "anchorY": 0.5, "anchorX": 0.5 }, "child": [{ "type": "Label", "props": { "y": 59, "x": 133, "wordWrap": true, "width": 140, "var": "lab_least0", "text": "底分：00", "leading": 6, "height": 31, "fontSize": 24, "color": "#ffffff", "anchorY": 0.5, "anchorX": 0.5, "align": "center" } }, { "type": "Label", "props": { "y": 105, "x": 133, "wordWrap": true, "width": 196, "var": "lab_money0", "text": "准入：00", "leading": 6, "height": 31, "fontSize": 26, "color": "#122452", "anchorY": 0.5, "anchorX": 0.5, "align": "center" } }] }, { "type": "Image", "props": { "y": 232, "var": "img_room1", "skin": "tongyong_ui/game_ui/tongyong/hud/difen_01.png", "right": 610, "name": "item1", "anchorY": 0.5, "anchorX": 0.5 }, "child": [{ "type": "Label", "props": { "y": 58, "x": 133, "wordWrap": true, "width": 140, "var": "lab_least1", "text": "底分：00", "leading": 6, "height": 31, "fontSize": 24, "color": "#ffffff", "anchorY": 0.5, "anchorX": 0.5, "align": "center" } }, { "type": "Label", "props": { "y": 103, "x": 133, "wordWrap": true, "width": 196, "var": "lab_money1", "text": "准入：00", "leading": 6, "height": 31, "fontSize": 26, "color": "#361147", "anchorY": 0.5, "anchorX": 0.5, "align": "center" } }] }, { "type": "Image", "props": { "y": 232, "var": "img_room2", "skin": "tongyong_ui/game_ui/tongyong/hud/difen_02.png", "right": 330, "name": "item2", "anchorY": 0.5, "anchorX": 0.5 }, "child": [{ "type": "Image", "props": { "y": 150, "x": 135, "skin": "paodekuai_ui/game_ui/paodekuai/difen_03_1.png", "anchorY": 0.5, "anchorX": 0.5 } }, { "type": "Label", "props": { "y": 358, "x": 125, "wordWrap": true, "width": 140, "var": "lab_least2", "text": "底分：00", "leading": 6, "height": 31, "fontSize": 24, "color": "#ffffff", "anchorY": 0.5, "anchorX": 0.5, "align": "center" } }, { "type": "Label", "props": { "y": 403, "x": 125, "wordWrap": true, "width": 196, "var": "lab_money2", "text": "准入：00", "leading": 6, "height": 31, "fontSize": 26, "color": "#0a4121", "anchorY": 0.5, "anchorX": 0.5, "align": "center" } }] }, { "type": "Image", "props": { "y": 232, "var": "img_room3", "skin": "tongyong_ui/game_ui/tongyong/hud/difen_03.png", "right": 50, "name": "item3", "anchorY": 0.5, "anchorX": 0.5 }, "child": [{ "type": "Image", "props": { "y": 131, "x": 135, "skin": "paodekuai_ui/game_ui/paodekuai/difen_04_1.png", "anchorY": 0.5, "anchorX": 0.5 } }, { "type": "Label", "props": { "y": 403, "x": 127, "wordWrap": true, "width": 196, "var": "lab_money3", "text": "准入：00", "leading": 6, "height": 31, "fontSize": 26, "color": "#5d360d", "anchorY": 0.5, "anchorX": 0.5, "align": "center" } }, { "type": "Label", "props": { "y": 358, "x": 126, "wordWrap": true, "width": 140, "var": "lab_least3", "text": "底分：00", "leading": 6, "height": 31, "fontSize": 24, "color": "#ffffff", "anchorY": 0.5, "anchorX": 0.5, "align": "center" } }] }] }] }, { "type": "Image", "props": { "top": 11, "skin": "paodekuai_ui/game_ui/paodekuai/ddz_title.png", "scaleY": 1, "scaleX": 1, "centerX": 127, "anchorY": 0.5, "anchorX": 0.5 } }, { "type": "Box", "props": { "width": 910, "visible": false, "var": "box_roomcard", "top": -1, "right": 0, "mouseThrough": true, "bottom": 0, "anchorY": 0.5, "anchorX": 0.5 }, "child": [{ "type": "Box", "props": { "width": 900, "right": 0, "height": 465, "centerY": 20, "anchorY": 0.5, "anchorX": 0.5 }, "child": [{ "type": "Image", "props": { "y": 232, "var": "img_room_create", "skin": "tongyong_ui/game_ui/tongyong/hud/tu_fangka.png", "right": 421, "anchorY": 0.5, "anchorX": 0.5 }, "child": [{ "type": "Image", "props": { "y": 14, "x": 43, "skin": "tongyong_ui/game_ui/tongyong/hud/tu_fangka2.png" } }] }, { "type": "Image", "props": { "y": 232, "var": "img_room_join", "skin": "tongyong_ui/game_ui/tongyong/hud/tu_fangka1.png", "right": 72, "anchorY": 0.5, "anchorX": 0.5 }, "child": [{ "type": "Image", "props": { "y": 39, "x": 83, "skin": "tongyong_ui/game_ui/tongyong/hud/tu_fangka3.png" } }] }] }] }] };
                    return PaoDeKuai_HUDUI;
                }(View));
                paodekuai.PaoDeKuai_HUDUI = PaoDeKuai_HUDUI;
            })(paodekuai = game_ui.paodekuai || (game_ui.paodekuai = {}));
        })(game_ui = nqp.game_ui || (nqp.game_ui = {}));
    })(nqp = ui.nqp || (ui.nqp = {}));
})(ui || (ui = {}));
