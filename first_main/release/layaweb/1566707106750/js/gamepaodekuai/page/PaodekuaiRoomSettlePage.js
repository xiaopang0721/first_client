...
(function (gamepaodekuai) {
    var page;
    (function (page) {
        var PaodekuaiRoomSettlePage = /** @class */ (function (_super) {
            __extends(PaodekuaiRoomSettlePage, _super);
            function PaodekuaiRoomSettlePage(v, onOpenFunc, onCloseFunc) {
            ...
            // 页面初始化函数
            PaodekuaiRoomSettlePage.prototype.init = function () {
                this._viewUI = this.createView('game_ui.paodekuai.JieSuan_FangKaUI');
                this.addChild(this._viewUI);
            };
            // 页面打开时执行函数
            PaodekuaiRoomSettlePage.prototype.onOpen = function () {
            ...
            //按钮点击
            PaodekuaiRoomSettlePage.prototype.onBtnTweenEnd = function (e, target) {
                switch (target) {
                    case this._viewUI.btn_create_room:
                        this._game.uiRoot.general.open(page.PaodekuaiPageDef.PAGE_PDK_CREATE_CARDROOM);
                        this.close();
                        break;
            ...
            // 设置最后结束时的按纽状态
            PaodekuaiRoomSettlePage.prototype.setGameEndBtnState = function (isEventOn) {
            ...
            PaodekuaiRoomSettlePage.prototype.renderHandler = function (cell, index) {
                if (cell) {
                    cell.setData(this._game, cell.dataSource);
                }
            };
            PaodekuaiRoomSettlePage.prototype.onBlackSpriteClick = function () {
                if (!this._isGameEnd)
                    return;
                _super.prototype.onBlackSpriteClick.call(this);
            };
            PaodekuaiRoomSettlePage.prototype.deltaUpdate = function () {
            ...
            PaodekuaiRoomSettlePage.prototype.close = function () {
                this.setGameEndBtnState(false);
                _super.prototype.close.call(this);
            };
            return PaodekuaiRoomSettlePage;
        }(game.gui.base.Page));
        page.PaodekuaiRoomSettlePage = PaodekuaiRoomSettlePage;
...
//# sourceMappingURL=PaodekuaiRoomSettlePage.js.map