...
(function (gametbniuniu) {
    var page;
    (function (page) {
        var TbNiuNiuRulePage = /** @class */ (function (_super) {
            __extends(TbNiuNiuRulePage, _super);
            function TbNiuNiuRulePage(v, onOpenFunc, onCloseFunc) {
            ...
            // 页面初始化函数
            TbNiuNiuRulePage.prototype.init = function () {
                this._viewUI = this.createView('game_ui.tbniuniu.TongBiNN_GuiZeUI');
                this.addChild(this._viewUI);
            };
            // 页面打开时执行函数
            TbNiuNiuRulePage.prototype.onOpen = function () {
            ...
            TbNiuNiuRulePage.prototype.selectHandler = function (index) {
            ...
            TbNiuNiuRulePage.prototype.close = function () {
                if (this._viewUI) {
                    this._viewUI.btn_tab.selectedIndex = -1;
                }
                _super.prototype.close.call(this);
            };
            return TbNiuNiuRulePage;
        }(game.gui.base.Page));
        page.TbNiuNiuRulePage = TbNiuNiuRulePage;
    })(page = gametbniuniu.page || (gametbniuniu.page = {}));
})(gametbniuniu || (gametbniuniu = {}));
//# sourceMappingURL=TbNiuNiuRulePage.js.map