...
(function (gamebrniuniu) {
    var page;
    (function (page) {
        var BrNiuNiuPlayerListPage = /** @class */ (function (_super) {
            __extends(BrNiuNiuPlayerListPage, _super);
            function BrNiuNiuPlayerListPage(v, onOpenFunc, onCloseFunc) {
            ...
            BrNiuNiuPlayerListPage.prototype.init = function () {
                this._viewUI = this.createView('game_ui.tongyong.WanJiaLBUI');
                this.addChild(this._viewUI);
            };
            // 页面打开时执行函数
            BrNiuNiuPlayerListPage.prototype.onOpen = function () {
            ...
            BrNiuNiuPlayerListPage.prototype.renderHandler = function (cell, index) {
                if (cell) {
                    cell.setData(this._game, cell.dataSource);
                }
            };
            BrNiuNiuPlayerListPage.prototype.onUpdateUnit = function () {
                var unitList = [];
            ...
            BrNiuNiuPlayerListPage.prototype.close = function () {
                if (this._viewUI) {
            ...
            return BrNiuNiuPlayerListPage;
        }(game.gui.base.Page));
        page.BrNiuNiuPlayerListPage = BrNiuNiuPlayerListPage;
        var PlayerItemRender = /** @class */ (function (_super) {
            ...
            PlayerItemRender.prototype.setData = function (game, data) {
                ...
                if (!this._clipNum) {
                    this._clipNum = new BrniuniuClip(BrniuniuClip.RANK_FONT2);
...
//# sourceMappingURL=BrNiuNiuPlayerListPage.js.map