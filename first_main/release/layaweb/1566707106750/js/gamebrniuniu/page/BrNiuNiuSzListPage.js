...
(function (gamebrniuniu) {
    var page;
    (function (page) {
        var BrNiuNiuSzListPage = /** @class */ (function (_super) {
            __extends(BrNiuNiuSzListPage, _super);
            function BrNiuNiuSzListPage(v, onOpenFunc, onCloseFunc) {
            ...
            BrNiuNiuSzListPage.prototype.init = function () {
                this._viewUI = this.createView('game_ui.tongyong.ShangZhuangLBUI');
                this.addChild(this._viewUI);
            };
            // 页面打开时执行函数
            BrNiuNiuSzListPage.prototype.onOpen = function () {
            ...
            //按钮缓动回调
            BrNiuNiuSzListPage.prototype.onBtnTweenEnd = function (e, target) {
                switch (target) {
            ...
            BrNiuNiuSzListPage.prototype.renderHandler = function (cell, index) {
                if (cell) {
                    cell.setData(this._game, cell.dataSource);
                }
            };
            BrNiuNiuSzListPage.prototype.onUpdateSZList = function () {
                var mapinfo = this._game.sceneObjectMgr.mapInfo;
                if (!mapinfo)
                    return;
                var unitSz = [];
                ...
                var limitMoney = page.BrNiuNiuMapPage.MONEY_LIMIT_CONFIG[mapinfo.GetMapLevel()][0];
            ...
            BrNiuNiuSzListPage.prototype.close = function () {
                if (this._viewUI) {
            ...
            return BrNiuNiuSzListPage;
        }(game.gui.base.Page));
        page.BrNiuNiuSzListPage = BrNiuNiuSzListPage;
...
//# sourceMappingURL=BrNiuNiuSzListPage.js.map