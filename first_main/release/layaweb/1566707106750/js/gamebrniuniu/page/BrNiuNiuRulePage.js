...
(function (gamebrniuniu) {
    var page;
    (function (page) {
        var BrNiuNiuRulePage = /** @class */ (function (_super) {
            __extends(BrNiuNiuRulePage, _super);
            function BrNiuNiuRulePage(v, onOpenFunc, onCloseFunc) {
            ...
            // 页面初始化函数
            BrNiuNiuRulePage.prototype.init = function () {
                this._viewUI = this.createView('game_ui.brniuniu.BaiRenNN_GuiZeUI');
                this.addChild(this._viewUI);
            };
            // 页面打开时执行函数
            BrNiuNiuRulePage.prototype.onOpen = function () {
            ...
            BrNiuNiuRulePage.prototype.selectHandler = function (index) {
            ...
            BrNiuNiuRulePage.prototype.close = function () {
                if (this._viewUI) {
                    this._viewUI.btn_tab.selectedIndex = -1;
                }
                _super.prototype.close.call(this);
            };
            return BrNiuNiuRulePage;
        }(game.gui.base.Page));
        page.BrNiuNiuRulePage = BrNiuNiuRulePage;
    })(page = gamebrniuniu.page || (gamebrniuniu.page = {}));
})(gamebrniuniu || (gamebrniuniu = {}));
//# sourceMappingURL=BrNiuNiuRulePage.js.map