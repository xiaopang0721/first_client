...
(function (gamezjh) {
    var page;
    (function (page) {
        var ZhaJinHuaPageOld = /** @class */ (function (_super) {
            __extends(ZhaJinHuaPageOld, _super);
            function ZhaJinHuaPageOld(v, onOpenFunc, onCloseFunc) {
                var _this = _super.call(this, v, onOpenFunc, onCloseFunc) || this;
                _this._leastTmep = [1, 5, 20, 50];
                _this._needMoney = [20, 200, 500, 1000];
                _this._asset = [
            ...
            // 页面初始化函数
            ZhaJinHuaPageOld.prototype.init = function () {
            ...
            // 页面打开时执行函数
            ZhaJinHuaPageOld.prototype.onOpen = function () {
            ...
            ZhaJinHuaPageOld.prototype.onBtnTweenEnd = function (e, target) {
            ...
            ZhaJinHuaPageOld.prototype.initPlayerInfo = function () {
            ...
            ZhaJinHuaPageOld.prototype.showTipsBox = function (limit) {
                var _this = this;
            ...
            ZhaJinHuaPageOld.prototype.chkPlayerIsGuest = function () {
                var _this = this;
                var result = false;
            ...
            ZhaJinHuaPageOld.prototype.close = function () {
                if (this._viewUI) {
            ...
            return ZhaJinHuaPageOld;
        }(game.gui.base.Page));
        page.ZhaJinHuaPageOld = ZhaJinHuaPageOld;
    })(page = gamezjh.page || (gamezjh.page = {}));
})(gamezjh || (gamezjh = {}));
//# sourceMappingURL=ZhaJinHuaPageOld.js.map